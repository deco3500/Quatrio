...
<div class="jumbotron text-center">
  <h1><img id="versi" src="logo.png" alt="logo"></h1>
  <h2><b><font color="white">Welcome to Versi</font></b></h2>
  <h4>Versi is a place where you can discuss controvesial topics with like-minded persons based on just the facts. We search the web for articles about these topics, pick the facts out and deliverthem to you so you don't have to deal with writer bias. So log in and join the conversation!</h4>
</div>
...
<div class="container-fluid text-center">
  <div class="row">
    <div id="trending" class="col-sm-7 text-center">
      <div class="row">
        <div class="col-sm-12">
      ...
      <div class="row">
        <div class="col-sm-3">
          <div class="well">
           <img id="threads" src="venezuela.jpg" height="100" width="200" alt="Avatar">
          </div>
        </div>
        <div class="col-sm-9">
          <div class="well">
      ...
      <div class="row">
        <div class="col-sm-3">
          <div class="well">
           <img id="threads" src="lindsay.jpeg" height="100" width="200" alt="Avatar">
          </div>
        </div>
        <div class="col-sm-9">
          <div class="well">
      ...
      <div class="row">
        <div class="col-sm-3">
          <div class="well">
           <img id="threads" src="ab.png" height="100" width="200" alt="Avatar">
          </div>
        </div>
        <div class="col-sm-9">
          <div class="well">
      ...
      <div class="row">
        <div class="col-sm-3">
          <div class="well">
           <img id="threads" src="mp.jpg" height="100" width="200" alt="Avatar">
          </div>
        </div>
        <div class="col-sm-9">
          <div class="well">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header text-center">
          ...
          <img id="avatar" src="image.png" height="200" width="400" alt="Avatar">
        </div>
        <div class="modal-body">
...
>>>>>>> fb18349799f4eea7bc2820a8446fb4868db5f1ce:index.php
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
