...
<div class="jumbotron text-center">
  ...
  <p id= "what"><b>Versi is a place where you can discuss controvesial topics with like-minded persons based on just the facts. We search the web for articles about these topics, pick the facts out and deliver them to you so you don't have to deal with writer bias. So log in and Join the Conversation!</b></p>
</div>
  ...
  <div class="row">
    <div id="trending" class="col-sm-7 text-center">
      ...
      <div class="row">
        <div class="col-sm-3">
          <div class="well">
           <img src="venezuela.jpg" height="100" width="200" alt="Avatar">
          </div>
        </div>
        <div class="col-sm-9">
          <div class="well">
      ...
      <div class="row">
        <div class="col-sm-3">
          <div class="well">
           <img src="lindsay.jpeg" height="100" width="200" alt="Avatar">
          </div>
        </div>
        <div class="col-sm-9">
          <div class="well">
      ...
      <div class="row">
        <div class="col-sm-3">
          <div class="well">
           <img src="ab.png" height="100" width="200" alt="Avatar">
          </div>
        </div>
        <div class="col-sm-9">
          <div class="well">
      ...
      <div class="row">
        <div class="col-sm-3">
          <div class="well">
           <img src="mp.jpg" height="100" width="200" alt="Avatar">
          </div>
        </div>
        <div class="col-sm-9">
          <div class="well">
