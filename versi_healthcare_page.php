...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item">
        <img src="medicine.jpg" alt="Image">
        <div class="carousel-caption">
          <h3>ObamaCare</h3>
          <p>
          Just weeks before the election, the Department of Health and Human Services has announced the premium increases for ObamaCare for next year. 
          </br>
          In 2017, the average mid-level ObamaCare plan — a “Silver Plan” — will cost you 22 percent more than 2016.
          </br>
          http://nypost.com/2016/10/29/buckle-up-for-the-biggest-healthcare-crisis-weve-ever-seen/
          </p>
        </div>
      </div>

      <div class="item">
        <img src="ins.jpg" alt="Image">
        <div class="carousel-caption">
          <h3>Fact 3</h3>
          <p>Random fact about euthanasia</p>
        </div>
      </div>

      <div class="item">
        <img src="doc.jpg" alt="Image">
        <div class="carousel-caption">
          <h3>Fact 4</h3>
          <p>Random fact about euthanasia</p>
        </div>
          ...
          <article class="row">
            <div class="col-md-2 col-sm-2 hidden-xs">
              <figure class="thumbnail">
                ...
                <figcaption class="text-center">will.i.am</figcaption>
              </figure>
            </div>
              ...
              <div class="panel panel-default arrow left">
                <div class="panel-body">
                  <header class="text-left">
                    <div class="comment-user"><i class="fa fa-user"></i>Will</div>
                    <time class="comment-date" datetime="16-12-2014 01:05"><i class="fa fa-clock-o"></i> Dec 16, 2014</time>
                  </header>
                  <div class="comment-post">
                    <p>
					Hhhh, Planning your family budget for next year just got more difficult </p>
                  </div>
